// This module performs a convolution of a 5x5 input window with three separate 5x5 filters.
// Eventually release three convolutional values for that three kernels.
...
module conv1_calc #(
  ...
  // 25 pixel values (8-bit unsigned) forming a 5x5 window
	...
	input  wire        [DATA_BITS-1:0] data_out_3,
	input  wire        [DATA_BITS-1:0] data_out_4,
	input  wire        [DATA_BITS-1:0] data_out_5,
	input  wire        [DATA_BITS-1:0] data_out_6,
	input  wire        [DATA_BITS-1:0] data_out_7,
	input  wire        [DATA_BITS-1:0] data_out_8,
	input  wire        [DATA_BITS-1:0] data_out_9,
	input  wire        [DATA_BITS-1:0] data_out_10,
	input  wire        [DATA_BITS-1:0] data_out_11,
	input  wire        [DATA_BITS-1:0] data_out_12,
	input  wire        [DATA_BITS-1:0] data_out_13,
	input  wire        [DATA_BITS-1:0] data_out_14,
	input  wire        [DATA_BITS-1:0] data_out_15,
	input  wire        [DATA_BITS-1:0] data_out_16,
	input  wire        [DATA_BITS-1:0] data_out_17,
	input  wire        [DATA_BITS-1:0] data_out_18,
	input  wire        [DATA_BITS-1:0] data_out_19,  
	input  wire        [DATA_BITS-1:0] data_out_20,
	input  wire        [DATA_BITS-1:0] data_out_21,
	input  wire        [DATA_BITS-1:0] data_out_22,
	input  wire        [DATA_BITS-1:0] data_out_23,
  ...
  // Accumulation values before the releasing.

	wire signed [19:0] calc_out_1;
	wire signed [19:0] calc_out_2;
	wire signed [19:0] calc_out_3;

  // Convert unsigned pixels to signed by prepending a '0'.
  ...
  // Sign-extended bias (12-bit)
	...
	// Stage 1: compute 13 partial sums (12 pairs + 1 single product)
	...
	// Stage 2: sum the pairs from stage 1 into 6 intermediate sums
	...
	// Stage 4: final sum of the three
